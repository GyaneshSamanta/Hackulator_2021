        ...
        regButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(fullname)) {
                    loginEmail.setError("Name is required");
                    return;
                }
                if (TextUtils.isEmpty(idNumber)) {
                    loginEmail.setError("ID is required");
                    return;
                }
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful())
                                                                {
                                                                    Toast.makeText(PatientRegistrationActivity.this,"Reg Successful",Toast.LENGTH_SHORT).show();
                                                                }
                                                                else
                                                                {
                                                                    Toast.makeText(PatientRegistrationActivity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
